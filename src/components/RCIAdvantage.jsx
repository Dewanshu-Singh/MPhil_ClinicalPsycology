        ...
        <motion.div 
          ...
          <div style={{ flex: '1 1 400px', paddingTop: '12px' }}>
            <p style={{ color: '#94a3b8', fontSize: '1.05rem', lineHeight: 1.7, maxWidth: '500px' }}>
              Since 2022, the Department of Clinical Psychology at SGVU has run this program under RCI norms — three batches graduated, one ongoing. This is not just a degree; it is your pathway to becoming a licensed mental health professional.
            </p>
          </div>
        </motion.div>
